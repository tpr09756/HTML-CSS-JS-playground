define(function () {
    ...
    internals.films = [
        ...
        { title: 'Das Cabinet des Dr.Caligari', year: 1920, director: 'Robert Wiene', imdbRating: 8.1 }
    ];

    externals.getFilm = function(index, callBack) {
        console.log('getfilms')
        callBack(internals.films[index]);
    };
